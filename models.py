...
class Carga(models.Model):
    ...
    semestrec = models.ForeignKey('Semestre', models.DO_NOTHING, db_column='semestrec')
...
class Silabo(models.Model):
    ...
    unidadc = models.CharField(max_length=40)
    capituloc = models.CharField(max_length=100)
    temac = models.CharField(max_length=200)
    sesionc = models.IntegerField()
    semestrec = models.CharField(max_length=10)
    idcargac = models.ForeignKey(Carga, models.DO_NOTHING, db_column='idCargac')  # Field name made lowercase.

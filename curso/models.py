...
class CursosHorarios(models.Model):
    ...
    day=models.CharField( max_length=2,blank=False,null=False)
    hrinit=models.CharField( max_length=2,blank=False,null=False)
    ...
    semestre=models.CharField( max_length=10,blank=False,null=False)
    id_cuso=models.ForeignKey(curso,on_delete=models.CASCADE)
    class Meta:
